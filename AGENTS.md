...
- Commit messages: short, imperative (e.g., "Fix index sidebar scroll");
  sign via 1Password SSH agent.
...
- Never hardcode secrets; use 1Password/ENV. Respect `PathValidator`
  (reject traversal).
